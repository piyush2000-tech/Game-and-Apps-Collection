...
public class FacebookActivity extends AppCompatActivity {
    ...
    SwipeRefreshLayout facebookSwipe;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        facebookSwipe = findViewById(R.id.facebbokSwipe);
        facebookWebView = findViewById(R.id.faceBookWebView);
        ...
        if(ConnectionManager.checkConnectivity(this)){
            facebookSwipe.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
                @Override
                public void onRefresh() {
                    facebookWebView.reload();
                    facebookSwipe.setRefreshing(false);
                }
            });

            facebookWebView.setWebViewClient(new Browser_Home());
            facebookWebView.setWebChromeClient(new Facebook());
    ...
    private class Facebook extends WebChromeClient {
