...
public class GoogleActivity extends AppCompatActivity {
    ...
    SwipeRefreshLayout swipeGoogle;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        swipeGoogle = findViewById(R.id.swipeGoogle);
        ...
        if(ConnectionManager.checkConnectivity(this)){
            swipeGoogle.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
                @Override
                public void onRefresh() {
                    googleWebView.reload();
                    swipeGoogle.setRefreshing(false);
                }
            });

            googleWebView.getSettings().setJavaScriptEnabled(true);
            googleWebView.setWebViewClient(new Browser_Home());
            googleWebView.setWebChromeClient(new Google());
            WebSettings webSettings = googleWebView.getSettings();

            webSettings.setJavaScriptEnabled(true);
            webSettings.setAllowFileAccess(true);
            webSettings.setAppCacheEnabled(true);
            //googleWebView.setBackgroundColor(Color.BLACK);
    ...
    private class Google extends WebChromeClient {
    ...
    public void onBackPressed() {
        ...
        builder.setMessage("Do you want to Exit Google Search?");
        builder.setIcon(R.drawable.ic_about_app);
        builder.setTitle("Alert!");
        builder.setCancelable(false);
