...
public class multiplyBrainActivity extends AppCompatActivity {
    ...
    public void newQuestion() {
        ...
        for (int i=0; i<4; i++) {
            if (i == locationOfCorrectAnswer) {
                ...
                int wrongAnswer = rand.nextInt(481);

                while (wrongAnswer == a*b) {
                    wrongAnswer = rand.nextInt(481);
                }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Multiply Game");

        multiplyTextView = findViewById(R.id.sumTextView);
        ...
        gameLayout.setBackgroundColor(Color.parseColor("#4CAF50"));
