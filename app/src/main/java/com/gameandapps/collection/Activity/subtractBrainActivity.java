...
public class subtractBrainActivity extends AppCompatActivity {
    ...
    public void newQuestion() {
        ...
        int a = rand.nextInt(50+20)-20;
        int b = rand.nextInt(50+20)-20;
        ...
        for (int i=0; i<4; i++) {
            if (i == locationOfCorrectAnswer) {
                ...
                int wrongAnswer = rand.nextInt(60+20)-20;

                while (wrongAnswer == a-b) {
                    wrongAnswer = rand.nextInt(60+20)-20;
                }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Subtraction Game");

        subTextView = findViewById(R.id.sumTextView);
