...
public class LinkdinActivity extends AppCompatActivity {
    ...
    WebView linkdinWebView;
    SwipeRefreshLayout linkdinSwipe;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        linkdinSwipe = findViewById(R.id.linkdinSwipe);
        linkdinWebView = findViewById(R.id.linkdinWebView);
        ...
        if(ConnectionManager.checkConnectivity(this)){
            linkdinSwipe.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
                @Override
                public void onRefresh() {
                    linkdinWebView.reload();
                    linkdinSwipe.setRefreshing(false);
                }
            });

            linkdinWebView.getSettings().setJavaScriptEnabled(true);
            linkdinWebView.setWebViewClient(new Browser_Home());
            linkdinWebView.setWebChromeClient(new Linkdin());
            WebSettings webSettings = linkdinWebView.getSettings();

            webSettings.setJavaScriptEnabled(true);
            webSettings.setAllowFileAccess(true);
            webSettings.setAppCacheEnabled(true);
            linkdinWebView.loadUrl("https://www.linkedin.com");
        }else{
    ...
    private class Linkdin extends WebChromeClient {
    ...
    public void onBackPressed() {
        if(linkdinWebView.canGoBack()){
            linkdinWebView.goBack();
        }else{
            final AlertDialog.Builder builder = new AlertDialog.Builder(this);

            builder.setMessage("Do you want to Exit Linkdin?");
            builder.setIcon(R.drawable.ic_about_app);
            builder.setTitle("Alert!");
            builder.setCancelable(false);
